...
import adminIcon from '../../imgs/admin1.png'

const SideNavBar = ({tab, settab})=> {


    return (
        <div style={{ backgroundColor: '#2575c0', minWidth: '250px' , height: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            ...
            <div style = {{padding : '7px'}}>
                ...
                {/* Dashboard */}
                <div style={{borderRadius : '12px', height: '55px' , marginBottom : '8px', display: 'flex', flexDirection: 'row', backgroundColor: tab.name == 'Dashboard' ? '#ffffff' : '#2575c0', alignItems: 'center', justifyContent: 'flex-start', paddingLeft: '10px' }}
                    onClick={() => {
                    ...
                    <p style={{letterSpacing : '1px',fontFamily: 'Roboto, sans-serif', color: tab.name == 'Dashboard' ? '#2575c0' : '#ffffff', fontWeight: '500', marginLeft: '8px' }}>
                        Dashboard
                    </p>
                </div>
                ...
                {/* Helpers */}
                <div style={{borderRadius : '12px', height: '55px' , marginBottom : '8px', display: 'flex', flexDirection: 'row', backgroundColor: tab.name == 'Helpers' ? '#ffffff' : '#2575c0', alignItems: 'center', justifyContent: 'flex-start', paddingLeft: '2px' }}
                    onClick={() => {
                    ...
                    <p style={{letterSpacing : '1px',fontFamily: 'Roboto, sans-serif', color: tab.name == 'Helpers' ? '#2575c0' : '#ffffff', fontWeight: '500', marginLeft: '7px' }}>
                        Helpers
                    </p>
                </div>
                ...
                <div style={{borderRadius : '12px', height: '55px' , marginBottom : '8px', display: 'flex', flexDirection: 'row', backgroundColor: tab.name == 'Customers' ? '#ffffff' : '#2575c0', alignItems: 'center', justifyContent: 'flex-start', paddingLeft: '10px' }}
                    ...
                    <p style={{letterSpacing : '1px',fontFamily: 'Roboto, sans-serif', color: tab.name == 'Customers' ? '#2575c0' : '#ffffff', fontWeight: '500', marginLeft: '11px' }}>
                        Customers
                    </p>
                </div>
                ...
                <div style={{borderRadius : '12px', height: '55px' , marginBottom : '8px', display: 'flex', flexDirection: 'row', backgroundColor: tab.name == 'Reports' ? '#ffffff' : '#2575c0', alignItems: 'center', justifyContent: 'flex-start', paddingLeft: '10px' }}
                    ...
                    <p style={{letterSpacing : '1px',fontFamily: 'Roboto, sans-serif', color: tab.name == 'Reports' ? '#2575c0' : '#ffffff', fontWeight: '500', marginLeft: '11px' }}>
                        Reports
                    </p>
                </div>
                ...
                <div style={{borderRadius : '12px', height: '55px' , marginBottom : '8px', display: 'flex', flexDirection: 'row', backgroundColor: tab.name == 'Certifications' ? '#ffffff' : '#2575c0', alignItems: 'center', justifyContent: 'flex-start', paddingLeft: '10px' }}
                    ...
                    <p style={{ letterSpacing : '1px',fontFamily: 'Roboto, sans-serif' ,color: tab.name == 'Certifications' ? '#2575c0' : '#ffffff', fontWeight: '500', marginLeft: '11px' }}>
                        Certifications
                    </p>
                </div>
            </div>
            ...
            <div>
                ...
                <div style={{borderRadius : '12px', height: '55px' , marginBottom : '8px', display: 'flex', flexDirection: 'row', backgroundColor: tab.name == 'Logout' ? '#ffffff' : '#2575c0', alignItems: 'center', justifyContent: 'flex-start', paddingLeft: '10px' }}
                    ...
                    <p style={{letterSpacing : '1px',fontFamily: 'Roboto, sans-serif' , color: tab.name == 'Logout' ? '#2575c0' : '#ffffff', fontWeight: '500', marginLeft: '11px' }}>
                        Logout
                    </p>
                </div>
