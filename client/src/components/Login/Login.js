...
//     setData(newData.data.provider[0]);
//     console.log(newData);
//     localStorage.setItem('user', newData.data.provider[0]._id);
    
//     if (newData.data.provider[0].user_type == "Helper")
//     {
//    navigate('/user/helperAccount');
  
//     }
//     else if (newData.data.provider[0].user_type == "Customer"){
...
//             <div
//               className="auth-main_row_left-col col-sm-7 col-12"
//               id="borders"
//             >
...
//               </h1>
//             </div>
//             <div className="auth-main_row_right-col col-sm-5 col-12">
